   ...
   public  class toolBox
    {
        ...
        public static ToolboxCategoryItems loadToolbox()
        {
            ...
            //调试用
            string path = System.Environment.CurrentDirectory + @"\toolBarImage\resultBookmark.png";
            ToolboxItemWrapper resultBookmark = new ToolboxItemWrapper(typeof(resultBookmark), path, "resultBookmark");
            ToolboxCategory debugActivity = new System.Activities.Presentation.Toolbox.ToolboxCategory("debugActivity");
            debugActivity.Add(resultBookmark);

            toolboxCategoryItems.Add(debugActivity);



            //例子

            //ToolboxItemWrapper 会签节点 = new ToolboxItemWrapper(typeof(Wxwinter.BPM.ActivitySample.会签.parallelActivity), "会签节点");
            //ToolboxItemWrapper 会签参与人 = new ToolboxItemWrapper(typeof(Wxwinter.BPM.ActivitySample.会签.parallelItem), "会签参与人");
            //ToolboxCategory 会签 = new System.Activities.Presentation.Toolbox.ToolboxCategory("会签");
            //会签.Add(会签节点);
            //会签.Add(会签参与人);

            //toolboxCategoryItems.Add(会签);
